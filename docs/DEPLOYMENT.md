...
앱인토스 번들·콘솔·QR 검수와 두 WebView origin CORS 설정은 [앱인토스 출시 기준](APPS_IN_TOSS_RELEASE.md)을 따른다. Render 무료 스테이징은 콜드 스타트와 백업 제한 때문에 앱인토스의 10초 최초 화면 및 상시 운영 증거로 사용할 수 없다.
