...
- `medium_photo_jeju_original.jpg`
- `medium_photo_jeju_modified.jpg`
...
- `hard_megalophobia_sky_whale_original.jpg`
- `hard_megalophobia_sky_whale_modified.jpg`
- `hard_megalophobia_titan_statue_original.jpg`
- `hard_megalophobia_titan_statue_modified.jpg`
- `hard_megalophobia_underwater_kraken_original.jpg`
- `hard_megalophobia_underwater_kraken_modified.jpg`

## 활성화 전 필수 확인

1. Paris, Heungbu, interior library, Jeju, Kyoto, New York와 megalophobia 5개 쌍의 정답 영역을 정규화 좌표로 검수한다.
